...
class BookingExteriorPaintingPage extends StatefulWidget {
  const BookingExteriorPaintingPage({Key? key}) : super(key: key);

@override
  _BookingExteriorPaintingPageState createState() => _BookingExteriorPaintingPageState();
}

class _BookingExteriorPaintingPageState extends State<BookingExteriorPaintingPage> {
  String? provider;
    ...
    return SafeArea(
      ...
      body: Stack(
        children: [
          SizedBox(
            ...
            child: Image.asset("assets/images/exterior.jpg"),
          ),
          buttonArrow(context),
          scroll(),
        ],
     ...
     bottomNavigationBar: FadeInUp(
        child: MaterialButton(
          ...
          onPressed: () {
            final String title = "Exterior Painting";
              final String price = "RM 50.00";
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Painting your homes exterior is like dressing it up for success and making it stand out from the rest. The beauty of painting is not just in the final result, but also in the process of rejuvenating and renewing your home.',
                    style: Theme.of(context)
                        .textTheme
                        .bodyMedium!
                        .copyWith(color: SecondaryText),
