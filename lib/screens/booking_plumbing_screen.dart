...
class BookingPlumbingPage extends StatefulWidget {
  const BookingPlumbingPage({Key? key}) : super(key: key);

@override
  _BookingPlumbingPageState createState() => _BookingPlumbingPageState();
}

class _BookingPlumbingPageState extends State<BookingPlumbingPage> {
  String? provider;
    ...
    return SafeArea(
      ...
      body: Stack(
        children: [
          SizedBox(
            ...
            child: Image.asset("assets/images/plumbing.jpg"),
          ),
          buttonArrow(context),
          scroll(),
        ],
     ...
     bottomNavigationBar: FadeInUp(
        child: MaterialButton(
          ...
          onPressed: () {
            final String title = "Plumbing";
              final String price = "RM 20.00";
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Plumbing is the invisible thread that ties our homes and communities together, transforming them into vibrant spaces of comfort and convenience. It is the backbone of modern living, allowing us to embrace the luxuries of indoor plumbing and experience the wonders of clean, running water at our fingertips. ',
                    style: Theme.of(context)
                        .textTheme
                        .bodyMedium!
                        .copyWith(color: SecondaryText),
