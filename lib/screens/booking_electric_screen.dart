...
class BookingElectricPage extends StatefulWidget {
  const BookingElectricPage({Key? key}) : super(key: key);

@override
  _BookingElectricPageState createState() => _BookingElectricPageState();
}

class _BookingElectricPageState extends State<BookingElectricPage> {
  String? provider;
    ...
    return SafeArea(
      ...
      body: Stack(
        children: [
          SizedBox(
            ...
            child: Image.asset("assets/images/electric.jpg"),
          ),
          buttonArrow(context),
          scroll(),
        ],
     ...
     bottomNavigationBar: FadeInUp(
        child: MaterialButton(
          ...
          onPressed: () {
            final String title = "Electrical";
              final String price = "RM 25.00";
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Electricity is the language of energy, speaking through currents and circuits, bringing light, heat, and life to all that it touches.In the realm of electric power, there is a symphony of electrons dancing through wires, creating a symphony of light, sound, and technological marvels.',
                    style: Theme.of(context)
                        .textTheme
                        .bodyMedium!
                        .copyWith(color: SecondaryText),
