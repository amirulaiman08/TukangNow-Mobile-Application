...
import 'package:tukangnow1/comps/styles.dart';
import 'package:tukangnow1/comps/widgets.dart';
...
class ChatPage extends StatefulWidget {
  ...
  const ChatPage({Key? key, required this.workerId, required this.userid, required this.provider}) : super(key: key);
                    ...
                    if (snapshot.hasData) {
                      if (snapshot.data!.docs.isNotEmpty) {
                        List<QueryDocumentSnapshot?> allData = snapshot
                            .data!.docs
                            .where((element) =>
                                element['users'].contains(widget.workerId) &&
                        ...
                        return Center(
                          child: Text(
                            'No conversion found',
                            style: Styles.h1()
                                .copyWith(color: Color.fromARGB(255, 93, 141, 187)),
                          ),
                        );
                      }
                    } else {
