...
class PowerCordBookingPage extends StatefulWidget {
  const PowerCordBookingPage({Key? key}) : super(key: key);

@override
  _PowerCordBookingPageState createState() => _PowerCordBookingPageState();
}

class _PowerCordBookingPageState extends State<PowerCordBookingPage> {
   String? provider;
    ...
    return SafeArea(
      ...
      body: Stack(
        children: [
          SizedBox(
            ...
            child: Image.asset("assets/images/powercord.jpg"),
          ),
          buttonArrow(context),
          scroll(),
        ],
     ...
     bottomNavigationBar: FadeInUp(
        child: MaterialButton(
          ...
          onPressed: () {
            final String title = "Power Cord Repair";
              final String price = "RM 15.00";
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Just as a repaired power cord conducts electricity, it channels your determination and resilience. A mended power cord not only restores connection but also ignites the spark of possibility',
                    style: Theme.of(context)
                        .textTheme
                        .bodyMedium!
                        .copyWith(color: SecondaryText),
