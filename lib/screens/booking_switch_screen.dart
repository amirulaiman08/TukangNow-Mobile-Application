...
class SwitchBookingPage extends StatefulWidget {
  const SwitchBookingPage({Key? key}) : super(key: key);

@override
  _SwitchBookingPageState createState() => _SwitchBookingPageState();
}

class _SwitchBookingPageState extends State<SwitchBookingPage> {
  String? provider;
    ...
    return SafeArea(
     ...
     bottomNavigationBar: FadeInUp(
        child: MaterialButton(
          ...
          onPressed: () {
            final String title = "Switch Repair";
            final String status = "Received";
              final String price = "RM 13.00";
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Switch repair typically involves identifying the cause of the problem, which could range from loose wiring connections to worn-out components. Once the issue is diagnosed, the repair process may involve disassembling the switch, inspecting and cleaning the internal components, replacing any damaged parts, and reassembling the switch.',
                    style: Theme.of(context)
                        .textTheme
                        .bodyMedium!
                        .copyWith(color: SecondaryText),
