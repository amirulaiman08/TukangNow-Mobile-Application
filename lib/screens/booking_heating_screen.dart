...
class HeatingBookingPage extends StatefulWidget {
  const HeatingBookingPage({Key? key}) : super(key: key);

@override
  _HeatingBookingPageState createState() => _HeatingBookingPageState();
}

class _HeatingBookingPageState extends State<HeatingBookingPage> {
   String? provider;
    ...
    return SafeArea(
      ...
      body: Stack(
        children: [
          SizedBox(
            ...
            child: Image.asset("assets/images/heating.jpg"),
          ),
          buttonArrow(context),
          scroll(),
        ],
     ...
     bottomNavigationBar: FadeInUp(
        child: MaterialButton(
          ...
          onPressed: () {
            final String title = "Heating Element Replacement";
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'A heating element is a testament to the wonders of science, harnessing energy to bring comfort and transform the ordinary into the extraordinary',
                    style: Theme.of(context)
                        .textTheme
                        .bodyMedium!
                        .copyWith(color: SecondaryText),
